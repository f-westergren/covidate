...
def login():
	...
	return render_template('/login.html', form=form, btnText="Log in", cancel='index', color="#99d3FF")
...
def signup():
  ...
  """
	...
	return render_template('signup.html', form=form, btnText="Sign Up", cancel='index', color="#99d3FF")
